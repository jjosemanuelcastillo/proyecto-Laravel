        ...
        <div class="row text-center">
            <div class="col-md-4">
                <div class="card bg-primary text-white shadow p-4">
                    ...
                    <a href="{{ route('admin.clientes.index') }}" class="btn btn-light text-primary fw-bold px-4 py-2">Ver Clientes</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card bg-success text-white shadow p-4">
                    ...
                    <a href="{{ route('admin.vehiculos.index') }}" class="btn btn-light text-success fw-bold px-4 py-2">Ver Vehículos</a>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card bg-warning text-dark shadow p-4">
                    ...
                    <a href="{{ route('admin.ventas.index') }}" class="btn btn-dark fw-bold px-4 py-2">Ver Ventas</a>
                </div>
            </div>
        </div>
        <a href="{{ route('logout') }}"
